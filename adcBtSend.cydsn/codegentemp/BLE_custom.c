...
const CYBLE_CUSTOMS_T cyBle_customs[0x01u] = {
    ...
    /* Number service */
    {
        0x000Eu, /* Handle of the Number service */ 
        {

            /* Number_Write characteristic */
            {
                0x0010u, /* Handle of the Number_Write characteristic */ 
            ...
            /* Number_Read characteristic */
            {
                0x0013u, /* Handle of the Number_Read characteristic */ 
            ...
            /* Number_Notify characteristic */
            {
                0x0016u, /* Handle of the Number_Notify characteristic */ 
            ...
            /* Number_Indicate characteristic */
            {
                0x001Au, /* Handle of the Number_Indicate characteristic */ 
